@extends('layouts.app', ['activePage' => 'profile', 'activeButton' => 'EnergyManagement', 'title' => 'Smart Reports', 'navName' => 'Edit Profile'])
                ...
                <div class="row">
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('photo') ? ' has-danger' : '' }}">
                                        ...
                                        @if(auth()->user()->picture) 
                                            <div class="pb-2">
                                                <img class="resize-image" src="{{ auth()->user()->profilePicture() }}" alt="profile">
                                            </div>
                                        @endif
                            ...
                            <hr class="my-4" />
                            <form method="post" action="{{ route('profile.password') }}" id="profile">
                                @csrf
                                @method('patch')
